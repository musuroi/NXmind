...
const Dock: React.FC<DockProps> = ({ notes, activeNoteId, onSelectNote, onReorder, onAction, position, onPositionChange, autoHide }) => {
    ...
    // Logic: Show if (hovered OR dragging OR menuOpen OR showIntro) OR !autoHide
    const shouldShow = !autoHide || isVisible || isDockDragging || contextMenu || showIntro;
